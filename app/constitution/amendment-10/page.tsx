...
export default function Amendment10Page() {
  return (
    <div className="bg-white">
      <section className="bg-gradient-to-br from-[#C41E3A] to-[#9B1829] text-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-6xl font-bold mb-4">X</div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg border-l-4 border-[#1A3A5C]">
            ...
            <p className="text-lg text-gray-800 leading-relaxed">
              If the Constitution doesn't give a power to the federal government (or forbid it to states), 
              that power stays with states or the people.
            </p>
          </div>
        </div>
      </section>
