...
export default function Amendment15Page() {
  return (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg shadow-lg border-l-4 border-[#1A3A5C] mb-8">
            ...
            <p className="text-lg text-gray-800 italic leading-relaxed mb-4">
              <strong>Section 1.</strong> "The right of citizens of the United States to vote shall not be denied or 
              abridged by the United States or by any State on account of race, color, or previous condition of servitude."
            </p>
            <p className="text-lg text-gray-800 italic leading-relaxed">
              <strong>Section 2.</strong> Congress may enforce this article by appropriate legislation.
            </p>
          </div>
