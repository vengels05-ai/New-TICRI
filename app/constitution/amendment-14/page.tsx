        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg shadow-lg border-l-4 border-[#1A3A5C] mb-8">
            ...
            <p className="text-lg text-gray-800 italic leading-relaxed mb-4">
              <strong>Section 1.</strong> "All persons born or naturalized in the United States, and subject to the jurisdiction thereof, 
            ...
            <p className="text-lg text-gray-800 italic leading-relaxed mb-4">
              <strong>Section 2.</strong> "Representatives shall be apportioned among the several States according to their respective 
              numbers, counting the whole number of persons in each State, excluding Indians not taxed. But when the right to vote at 
              any election for the choice of electors for President and Vice-President of the United States, Representatives in Congress, 
              the Executive and Judicial officers of a State, or the members of the Legislature thereof, is denied to any of the male 
              inhabitants of such State, being twenty-one years of age, and citizens of the United States, or in any way abridged, except 
            ...
            <p className="text-lg text-gray-800 italic leading-relaxed mb-4">
              <strong>Section 3.</strong> "No person shall be a Senator or Representative in Congress, or elector of President and 
              Vice-President, or hold any office, civil or military, under the United States, or under any State, who, having previously 
              taken an oath, as a member of Congress, or as an officer of the United States, or as a member of any State legislature, or 
              as an executive or judicial officer of any State, to support the Constitution of the United States, shall have engaged in 
            ...
            <p className="text-lg text-gray-800 italic leading-relaxed mb-4">
              <strong>Section 4.</strong> "The validity of the public debt of the United States, authorized by law, including debts 
            ...
            <p className="text-lg text-gray-800 italic leading-relaxed">
              <strong>Section 5.</strong> "The Congress shall have the power to enforce, by appropriate legislation, the provisions of 
              this article."
            </p>
          </div>
