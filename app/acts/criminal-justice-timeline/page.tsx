            ...
            <div className="space-y-12">
              <div key="0" className={`relative flex items-start ${0 % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                ...
                <div className={`ml-24 md:ml-0 ${0 % 2 === 0 ? 'md:mr-auto md:pr-12' : 'md:ml-auto md:pl-12'} md:w-5/12`}>
                  <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-600 hover:shadow-xl transition-shadow">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Civil Asset Forfeiture Reform Act (CAFRA, 2000)</h3>
                    <p className="text-gray-700">- Established procedural safeguards for property owners in civil forfeiture cases.   - Required the government to prove forfeiture cases by a preponderance of evidence.   - Created an “innocent owner” defense and hardship release provisions.   ---</p>
                  </div>
                </div>
              </div>
              <div key="1" className={`relative flex items-start ${1 % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                ...
                <div className={`ml-24 md:ml-0 ${1 % 2 === 0 ? 'md:mr-auto md:pr-12' : 'md:ml-auto md:pl-12'} md:w-5/12`}>
                  <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-600 hover:shadow-xl transition-shadow">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">First Step Act (2018)</h3>
                    <p className="text-gray-700">- Major bipartisan sentencing and prison reform law.   - Reduced mandatory minimums for certain drug crimes, expanded the “safety valve” exception.   - Made the Fair Sentencing Act (2010) retroactive, addressing crack/powder cocaine disparities.   - Expanded rehabilitation and early release opportun</p>
                  </div>
                </div>
              </div>
              <div key="2" className={`relative flex items-start ${2 % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                ...
                <div className={`ml-24 md:ml-0 ${2 % 2 === 0 ? 'md:mr-auto md:pr-12' : 'md:ml-auto md:pl-12'} md:w-5/12`}>
                  <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-600 hover:shadow-xl transition-shadow">
                    ...
                    <p className="text-gray-700">These reforms:   - Protect property rights from overreach by law enforcement.   - Provide sentencing relief and rehabilitation opportunities.   - Highlight the ongoing debate over mass incarceration, due process, and proportional justice.   ---</p>
                  </div>
                </div>
              </div>
              <div key="3" className={`relative flex items-start ${3 % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                ...
                <div className={`ml-24 md:ml-0 ${3 % 2 === 0 ? 'md:mr-auto md:pr-12' : 'md:ml-auto md:pl-12'} md:w-5/12`}>
                  <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-600 hover:shadow-xl transition-shadow">
                    ...
                    <p className="text-gray-700">- [U.S. Code – Title 18 (Crimes and Criminal Procedure)](https://uscode.house.gov/view.xhtml?path=/prelim@title18&amp;edition=prelim)   - [Congress.gov – CAFRA 2000](https://www.congress.gov/bill/106th-congress/house-bill/1658)   - [Congress.gov – First Step Act 2018](https://www.congress.gov/bill/115th</p>
                  </div>
                </div>
              </div>
            </div>
