      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `Mississippi passed a law banning most abortions after 15 weeks of pregnancy, directly challenging <em>Roe v. Wade</em> (1973) and <em>Planned Parenthood v. Casey</em> (1992). The Supreme Court, in a 6–3 decision, upheld the law and explicitly <strong>overruled Roe and Casey</strong>, holding that the Constitution does not confer a right to abortion.` }} />
          </div>
