      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `James Obergefell and other same-sex couples challenged state bans on same-sex marriage. The Supreme Court ruled 5–4 that the <strong>14th Amendment’s Due Process and Equal Protection Clauses</strong> guarantee the fundamental right to marry for same-sex couples.` }} />
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-600">
                ...
                <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: `States’ ability to ban or refuse to recognize same-sex marriages.` }} />
              </div>
            </div>
          </div>
