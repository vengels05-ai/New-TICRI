      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `The decision inflamed sectional tensions, delegitimized compromise efforts, and accelerated the nation’s slide toward the Civil War. It is widely regarded as one of the Court’s gravest mistakes.` }} />
          </div>
...
- <strong>Took Away:</strong> Congress’s power to ban slavery in U.S. territories.` }} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `This was blatant judicial overreach, reading racist assumptions into constitutional silence and striking down long-standing political compromises. It undermined both the Court’s legitimacy and the Union’s stability.` }} />
          </div>
