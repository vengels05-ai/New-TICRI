      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `Nebraska made it illegal to teach modern foreign languages to young children. A teacher (Meyer) was convicted for teaching German. The Supreme Court struck down the law, holding that the <strong>14th Amendment’s Due Process Clause</strong> protects a broad “liberty” interest, including <strong>parents’ right to direct their children’s education</strong> and teachers’ right to teach.` }} />
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
                ...
                <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: `Constitutional recognition of parents’ authority over children’s education and of teachers’ liberty to teach.` }} />
              </div>

              <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-600">
                <h3 className="font-bold text-gray-900 mb-2">❌ Took Away:</h3>
                <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: `States’ power to impose sweeping, nativist restrictions on classroom content.` }} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `The Court read “liberty” broadly, but grounded it in longstanding traditions of family autonomy and education. Most view it as the Court doing what it should: protecting fundamental liberties from arbitrary laws.` }} />
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white rounded-lg shadow-lg p-8 mb-6">
            ...
            <p className="text-gray-100 leading-relaxed" dangerouslySetInnerHTML={{ __html: `Parents have a constitutional say in their kids’ schooling. States can regulate education, but they can’t trample basic family choices or ban subjects without strong reasons.` }} />
          </div>
