export default function MarburyVMadisonPage() {
  return (
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              This case <strong>cemented judicial review</strong>: federal courts have the duty and power to refuse to enforce laws that violate the Constitution. It defined the Court's role as the final expositor of what the law is.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
                ...
                <p className="text-gray-700">
                  A clear statement that courts can <strong>invalidate unconstitutional laws</strong> and must follow the Constitution first.
                </p>
              </div>
              ...
              <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-600">
                ...
                <p className="text-gray-700">
                  Any idea that Congress can <strong>expand the Supreme Court's original jurisdiction</strong> beyond what Article III allows.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Bold, but within the Court's job description. Marshall rooted the ruling in constitutional text and structure (Article III supremacy and the judicial oath).
            </p>
            <p className="text-gray-700 leading-relaxed">
              Most scholars view it as the Court doing <strong>exactly</strong> what it's supposed to do—say what the law is when a statute and the Constitution conflict.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white rounded-lg shadow-lg p-8 mb-6">
            ...
            <p className="text-gray-100 leading-relaxed mb-4">
              If a law clashes with the Constitution, <strong className="text-white">the Constitution wins</strong>.
            </p>
            <p className="text-gray-100 leading-relaxed">
              That's why modern rights cases—free speech, due process, gun rights, searches, elections—are all litigated with courts checking statutes and government actions against the Constitution.
            </p>
          </div>
