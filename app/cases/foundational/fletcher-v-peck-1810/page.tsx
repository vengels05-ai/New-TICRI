      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `This was the <strong>first time the Supreme Court struck down a state law as unconstitutional</strong>. It established the Court’s authority to check state legislation against the federal Constitution.` }} />
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-600">
                ...
                <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: `States’ power to retroactively cancel grants and contracts once finalized.` }} />
              </div>
            </div>
          </div>
