      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `The case concerned the tolling of statutes of limitations under the <strong>Soldiers’ and Sailors’ Civil Relief Act (SSCRA)</strong>. The Supreme Court unanimously reaffirmed that the Act must be <strong>read liberally in favor of servicemembers</strong>, rejecting attempts to narrowly limit its scope.` }} />
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-600">
                ...
                <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: `Judicial attempts to restrict servicemembers’ rights through narrow readings.` }} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `The Court acted within its proper role, defending Congress’s protective intent for servicemembers.` }} />
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white rounded-lg shadow-lg p-8 mb-6">
            ...
            <p className="text-gray-100 leading-relaxed" dangerouslySetInnerHTML={{ __html: `If you’re serving in the military, deadlines in lawsuits (like filing claims) pause during your service. Courts must apply that pause generously in your favor.` }} />
          </div>
